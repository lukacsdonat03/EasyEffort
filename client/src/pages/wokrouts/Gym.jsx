...
import stockImage1 from '../../img/gymstock01.jpg'
import stockImage2 from '../../img/gymstock02.jpg'
import stockImage3 from '../../img/gymstock03.jpg'

export const Gym = () => {
  return (
    <>
      <Typography align="center" variant="h3">
        Welcome to the Gym Exrecises
      </Typography>
      ...
      <Grid container className="workout-container" spacing={2} direction={"row"} justifyContent={'center'}>
